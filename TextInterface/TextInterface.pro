...
INCLUDEPATH += $$_PRO_FILE_PWD_"/../PDCurses"
# Windows users like when dependencies are
# resolved magically with unnecessary efforts
win32:LIBS += -L$$_PRO_FILE_PWD_"/../PDCurses/win32" -lpdcurses
# While Linux users prefer to build everything themselfs..
unix:LIBS += -L$$_PRO_FILE_PWD_"/../PDCurses/x11" -lpdcurses
#bles all the APIs deprecated before Qt 6.0.0
